...
from data_utils import LJSpeechTextMelLoader, TextMelCollate
from loss_function import Tacotron2Loss_VAE
from logger import Tacotron2Logger
# from hparams import create_hparams
from hparams import create_ljspeech_hparams
...
def prepare_dataloaders(hparams):
    ...
    trainset = LJSpeechTextMelLoader(hparams.training_files, hparams)
    valset = LJSpeechTextMelLoader(hparams.validation_files, hparams)
...
#                     iteration, reduced_loss, grad_norm, duration))
                ...
                print("Train loss {} {:.6f} recon_loss: {:.4f}, kl: {:.4f}, Grad Norm {:.6f} {:.2f}s/it".format(
                    iteration, reduced_loss, recon_loss, kl, grad_norm, duration))
                logger.log_training(
...
if __name__ == '__main__':
    ...
    hparams = create_ljspeech_hparams(args.hparams)
